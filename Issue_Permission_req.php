...
<center><h1>Provide Permission Issue Books</h1><center>
    <br><br>
<form action="Issue_update_permission.php" method="post">
<table id="tab">
<td>user_id : </td>
            ...
            <td><select name="Issue_Request" id="">
            <option value="<?php echo $row['Issue_Request'] ?>" selected><?php echo $row['Issue_Request'] ?></option>
