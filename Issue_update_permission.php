<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        name='$name',bname='$bname',bid='$bid',Issue_book_date='$Issue_book_date',Issue_Request='$Issue_Request',payment_status='$payment_status' WHERE user_id ='$user_id'";

        if(mysqli_query($conn,$sql)){
            echo "Provide Request Successfully Successfully";
            header('location:View_all_Issue_request_Details.php');
        }else{
